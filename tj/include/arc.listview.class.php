...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<li><a href='".str_replace("{page}",$prepagenum,$tnamerule)."'>&nbsp;<i class=\"fa fa-angle-left\"></i></a></li>\r\n";
            $indexpage="<li><a href='".str_replace("{page}",1,$tnamerule)."'>首页</a></li>\r\n";
        }
        else
        {
            $prepage.="<li><a href='javascript:;'>&nbsp;<i class=\"fa fa-angle-left\"></i></a></li>\r\n";
            $indexpage="<li>首页</li>\r\n";
        }
        ...
        {
            $nextpage.="<li><a href='".str_replace("{page}",$nextpagenum,$tnamerule)."'>&nbsp;<i class=\"fa fa-angle-right\"></i></a></li>\r\n";
            $endpage="<li><a href='".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a></li>\r\n";
        }
        else
        {
            $nextpage.="<li><a href='javascript:;'>&nbsp;<i class=\"fa fa-angle-right\"></i></a></li>\r\n";
            $endpage="<li>末页</li>\r\n";
        }
