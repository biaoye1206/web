...
function lib_type(&$ctag,&$refObj)
{
  ...
  if(empty($typeid)) return '';
    ...
    $row = $dsql->GetOne("SELECT id,typename,typeeng,content,description,typeicon,typecss,typepic,typebg,typedir,isdefault,ispart,defaultname,namerule2,moresite,siteurl,sitepath 
