...
else if($dopost=='savequick')
{
    ...
    $queryTemplate = "INSERT INTO `#@__arctype`(reid,topid,sortrank,typename,typeeng,typeicon,typecss,typepic,typebg,typedir,isdefault,defaultname,issend,channeltype,
...
else if($dopost=='save')
{
    ...
    $in_query = "INSERT INTO `#@__arctype`(reid,topid,sortrank,typename,typeeng,typeicon,typecss,typepic,typebg,typedir,isdefault,defaultname,issend,channeltype,
    ...
    VALUES('$reid','$topid','$sortrank','$typename','$typeeng','$typeicon','$typecss','$typepic','$typebg','$typedir','$isdefault','$defaultname','$issend','$channeltype',
